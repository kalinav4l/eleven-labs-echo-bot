...
const MainChat = () => {
  ...
  return (
    <DashboardLayout>
            ...
            {isNewChat ? (
                  ...
                  <div className="mx-auto w-full max-w-3xl">
                    <div className="relative rounded-full border border-border/60 bg-muted/20 shadow-sm hover:shadow transition-shadow">
                      ...
                      <Textarea
                        ...
                        rows={1}
                        className={cn(
                          'min-h-[48px] max-h-40 resize-none w-full bg-transparent border-0 pl-10 pr-16 py-3 text-left',
              ...
              <div className="space-y-6">
                {localMessages.map((message) => (
                  <div
                    key={message.id}
                    className={cn('group', message.isUser ? 'ml-12 md:ml-24' : 'mr-12 md:mr-24')}
                  >
                    <div className="flex gap-3">
                      <div
                        className={cn(
                          'w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 text-white',
                          message.isUser ? 'bg-primary' : 'bg-muted-foreground'
                        )}
                      >
        ...
        {!isNewChat && (
          <div className="fixed inset-x-0 bottom-12 z-50 pointer-events-none">
