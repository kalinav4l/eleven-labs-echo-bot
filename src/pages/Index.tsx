      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
          {statCards.map((stat, index) => (
            <div key={index} className="p-3 sm:p-6 bg-white border border-gray-200 rounded-lg">
            ...
            <div className="space-y-3 sm:space-y-4">
              {quickActions.map((action, index) => (
                <Link key={index} to={action.link}>
                  <div className={`p-3 sm:p-4 rounded-lg border transition-all duration-200 hover:bg-gray-50 cursor-pointer ${
                    action.primary 
        ...
        <div className="mt-6 sm:mt-8">
          <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Your Agents</h2>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-sm sm:text-base font-medium text-gray-900 truncate">domic.md Kalina</h3>
                    <p className="text-xs sm:text-sm text-gray-600 line-clamp-2">AI consulting agent generated automatically for domic.md Kalina</p>
