...
const Index = () => {
  ...
  const recentActivity = [
    {
      title: 'Created agent "domic.md Kalina"',
      date: "02.07.2025",
      type: "agent"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {statCards.map((stat, index) => (
              <Card key={index} className="bg-white border border-gray-200 hover:bg-gray-50/30 transition-all duration-200">
