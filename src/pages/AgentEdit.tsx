  ...
  return (
    <div className="p-4 lg:p-6 space-y-4 lg:space-y-6 lg:px-[240px] lg:my-[60px] py-[38px]">
        ...
        <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          ...
          <Button onClick={() => setIsTestModalOpen(true)} className="bg-accent text-white hover:bg-accent/90 border border-accent/20 shadow-md flex items-center gap-2 w-full lg:w-auto transition-all duration-200">
