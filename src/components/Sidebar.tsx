...
const Sidebar = ({
  ...
  return (
    <div className={`fixed inset-y-0 left-0 z-40 w-64 liquid-glass border-r border-border transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static`}>
