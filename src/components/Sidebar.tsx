...
const Sidebar = ({
  ...
  return <div className={`fixed inset-y-0 left-0 z-40 w-64 liquid-glass border-r border-border transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static`}>
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <button onClick={onClose} className="lg:hidden text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-accent/20 rounded-lg p-1 transition-colors">
