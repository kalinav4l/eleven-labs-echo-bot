  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gray-900 border-gray-800 text-white">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-white">Creează Lot Nou de Apeluri</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="callName" className="text-gray-300">Numele Campaniei</Label>
              <Input
                id="callName"
                value={callName}
          ...
          <div>
            <Label htmlFor="agentPhoneId" className="text-gray-300">Phone Number ID</Label>
            <Input
              id="agentPhoneId"
              value={agentPhoneId}
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <Label className="text-gray-300 text-lg">Destinatari</Label>
              <div className="flex space-x-2">
                <label className="cursor-pointer">
                  <input
                    ...
                    className="hidden"
                  />
                  <Button type="button" variant="outline" size="sm" className="bg-gray-800 border-gray-700 text-gray-300">
            ...
            <div className="space-y-3 max-h-60 overflow-y-auto">
              {recipients.map((recipient, index) => (
                <div key={index} className="grid grid-cols-12 gap-2 items-center p-3 bg-gray-800 rounded-lg">
